...
\title{VEGA Continuum Evolution: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA Continuum Evolution'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
